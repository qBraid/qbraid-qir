...
def generate_module_id(program: openqasm3.ast.Program) -> str:
    """
...
class Qasm3Module:
    ...
    def __init__(self, name: str, module: Module, num_qubits: int, elements):
        self._name = name
        self._module = module
